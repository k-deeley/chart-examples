...
classdef tAnnulusChart < tChart
    ...
    methods ( Test )
        ...
        function tLabelPropertiesUpdateRenderedLabels( testCase )
            ...
            actualText = string( {testCase.Chart.WedgeLabels.String} ).';
            ...
            drawnow()
            actualVisible = string( [testCase.Chart.WedgeLabels.Visible] );
            testCase.verifyEqual( actualVisible, ["off", "off"], ...
        ...
        function tLegendTextUpdatesRenderedLegend( testCase )
            ...
            actual = string( testCase.Chart.Legend.String(:) );
        ...
        function tLegendOnOffPropertyUpdatesLegend( testCase, ...
            ...
            % Verify that the underlying legend is correct.
            actual = string( testCase.Chart.Legend.(erase( ...
                propertyName, "Legend" )) );
            testCase.verifyEqual( actual, expected, ...
                "Setting the chart's '" + propertyName + ...
                "' property did not update the legend correctly." )
        ...
        function tControlsPropertyUpdatesLayout( testCase )
            ...
            drawnow()
            actual = string( testCase.Chart.LayoutGrid.ColumnWidth );
            testCase.verifyEqual( actual, ["1x", "fit"], ...
            ...
            drawnow()
            actual = string( testCase.Chart.LayoutGrid.ColumnWidth );
            testCase.verifyEqual( actual, ["1x", "0x"], ...
