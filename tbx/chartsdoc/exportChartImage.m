...
%in the example scripts. Call this function with no inputs to regenerate 
%and export all images. Alternatively, provide a list of required chart 
%names. Only the specified chart images will be exported.
